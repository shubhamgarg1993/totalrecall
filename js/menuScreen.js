...
menuState.prototype = {
  ...
  setScreen:function()
  {
   ...
   var start_button = this.add.button(959,1018,'tap',this.onStartClick,this);
   start_button.anchor.set(0.5,0.5);
    
   var lb_button = this.add.button(958,823,'leaderboardbutton',this.onLeaderBoardClick,this);
   lb_button.anchor.set(0.5,0.5);
